...
export declare namespace youtube_v3 {
    ...
    export class Resource$Commentthreads {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        update(params: Params$Resource$Commentthreads$Update, options: StreamMethodOptions): GaxiosPromise<Readable>;
        update(params?: Params$Resource$Commentthreads$Update, options?: MethodOptions): GaxiosPromise<Schema$CommentThread>;
        update(params: Params$Resource$Commentthreads$Update, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
    ...
    export class Resource$Videos {
        ...
        getRating(params?: Params$Resource$Videos$Getrating, options?: MethodOptions): GaxiosPromise<Schema$VideoRatingListResponse>;
        ...
        getRating(params: Params$Resource$Videos$Getrating, options: MethodOptions | BodyResponseCallback<Schema$VideoRatingListResponse>, callback: BodyResponseCallback<Schema$VideoRatingListResponse>): void;
        getRating(params: Params$Resource$Videos$Getrating, callback: BodyResponseCallback<Schema$VideoRatingListResponse>): void;
        getRating(callback: BodyResponseCallback<Schema$VideoRatingListResponse>): void;
        /**
         * Inserts a new resource into this collection.
         * @example
         * ```js
